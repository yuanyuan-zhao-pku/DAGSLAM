...
file_acc_m_each = os.path.join(default_save_path, "each_acc_m_DAGSLAM.csv")
# file_acc_m_each = os.path.join(default_save_path, "each_acc_m_NOTEARS.csv")
# file_acc_m_each = os.path.join(default_save_path, "each_acc_m_DAGMA.csv")

with open(file_acc_m_each, mode="w", newline="") as file:
