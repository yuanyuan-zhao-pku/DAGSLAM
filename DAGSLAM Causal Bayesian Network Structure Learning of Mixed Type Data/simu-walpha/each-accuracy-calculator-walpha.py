...
file_acc_walpha_each = os.path.join(default_save_path, "each_acc_alpha_DAGSLAM.csv")
# file_acc_walpha_each = os.path.join(default_save_path, "each_acc_alpha_NOTEARS.csv")
# file_acc_walpha_each = os.path.join(default_save_path, "each_acc_alpha_DAGMA.csv")

with open(file_acc_walpha_each, mode="w", newline="") as file:
