...
file_acc_s0_each = os.path.join(default_save_path, "each_acc_s0_DAGSLAM.csv")
# file_acc_s0_each = os.path.join(default_save_path, "each_acc_s0_NOTEARS.csv")
# file_acc_s0_each = os.path.join(default_save_path, "each_acc_s0_DAGMA.csv")

with open(file_acc_s0_each, mode="w", newline="") as file:
