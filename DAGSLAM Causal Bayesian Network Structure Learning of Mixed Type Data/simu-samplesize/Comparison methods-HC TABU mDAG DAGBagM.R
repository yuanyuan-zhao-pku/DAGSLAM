...
write.csv(results_avg, file.path(default_save_path, "acc_n_HC.csv"), row.names = FALSE)   
write.csv(results, file.path(default_save_path, "each_acc_n_HC.csv"), row.names = FALSE)   
...
# Write results to CSV files  
write.csv(results_avg, file.path(default_save_path, "acc_n_TABU.csv"), row.names = FALSE)   
write.csv(results, file.path(default_save_path, "each_acc_n_TABU.csv"), row.names = FALSE)   

# mDAG -------------------------------------------------------------  
library(mDAG)  

# Define loss type ('g' for 'gauss' and 'c' for 'categorical')
get_loss_type <- function(n) {  
  return(c(rep("g", 18), "c", "g"))  
}  

# Define levels for categorical nodes
get_level <- function(n) {  
  loss_type_str <- get_loss_type(n)  
...
# Write results to CSV files  
write.csv(results_avg, file.path(default_save_path, "acc_n_mDAG.csv"), row.names = FALSE)   
...
# Write results to CSV files  
write.csv(results_avg, file.path(default_save_path, "acc_n_DAGBagM.csv"), row.names = FALSE)   
