...
file_acc_distribution_each = os.path.join(
    default_save_path, "each_acc_distribution_DAGSLAM.csv"
)
# file_acc_distribution_each = os.path.join(
#     default_save_path, "each_acc_distribution_NOTEARS.csv"
# )
# file_acc_distribution_each = os.path.join(
#     default_save_path, "each_acc_distribution_DAGMA.csv"
# )

with open(file_acc_distribution_each, mode="w", newline="") as file:
