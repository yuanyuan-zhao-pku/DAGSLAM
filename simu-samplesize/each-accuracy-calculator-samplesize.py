...
file_acc_n_each = os.path.join(default_save_path, "each_acc_n_DAGSLAM.csv")
# file_acc_n_each = os.path.join(default_save_path, "each_acc_n_NOTEARS.csv")
# file_acc_n_each = os.path.join(default_save_path, "each_acc_n_DAGMA.csv")

with open(file_acc_n_each, mode="w", newline="") as file:
